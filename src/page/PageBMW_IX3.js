...
function PageSelectCar() {
  ...
  return (
    ...
    <Grid columns={2}>
                    <Box>
                        <ul>
                        <h3 align="left">BWM IX3</h3>
                        <img src="https://carsguide-res.cloudinary.com/image/upload/f_auto,fl_lossy,q_auto,t_default/v1/editorial/vhs/BMW-IX3-index.png" alt="react logo" style={{ width: '400px', }}/>
                        <br></br>
                        <br></br>
