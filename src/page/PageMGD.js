...
function PageSelectCar() {
  ...
  return (
    ...
    <Grid columns={2}>
                    <Box>
                        <ul>
                        <h3 align="left">MG ZS EV D</h3>
                        <img src="https://firebasestorage.googleapis.com/v0/b/se-database-e3659.appspot.com/o/Car%2Fcar1.png?alt=media&token=7833969c-915e-4c26-bcff-05619f3f1d2a" alt="react logo" style={{ width: '400px', }}/>
                        <br></br>
                        <br></br>
