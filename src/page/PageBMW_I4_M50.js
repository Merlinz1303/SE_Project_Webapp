...
function PageSelectCar() {
  ...
  return (
    ...
    <Grid columns={2}>
                    <Box>
                        <ul>
                        <h3 align="left">BWM I4 M50</h3>
                        <img src="https://imgd.aeplcdn.com/0x0/n/cw/ec/109123/i4-exterior-right-front-three-quarter.jpeg?isig=0" alt="react logo" style={{ width: '400px', }}/>
                        <br></br>
                        <br></br>
