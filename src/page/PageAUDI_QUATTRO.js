...
function PageSelectCar() {
    ...
    <Grid columns={2}>
                    <Box>
                        ...
                        <ul>
                        <h3 align="left">Audi e-tron GT quattro</h3>
                        <img src="https://platform.cstatic-images.com/xlarge/in/v2/stock_photos/b2a647b8-8b5d-4ca8-bc08-71c93e113b98/cc514430-3cf9-4bce-9523-9c01d130cd50.png" alt="react logo" style={{ width: '400px', }}/>
                        <br></br>
                        <br></br>
                    ...
                    <Box1>
                        <h3>ระยะเวลา</h3>
                        <h4 align="left"> <input type="checkbox" shape="round" variant="fill" value="2000" checked={month === "36"} onChange={() => setMonth("36")} /> 36 เดือน&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" shape="round" variant="fill" checked={month === "48"} onChange={() => setMonth("48")}/>48 เดือน&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" shape="round" variant="fill" checked={month === "60"} onChange={() => setMonth("60")}/>60 เดือน</h4> 
                        <hr></hr>
                        <h3>ระยะทางรวม</h3>
